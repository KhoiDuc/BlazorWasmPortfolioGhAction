...
namespace BlazorWasmPortfolioGhAction.Pages
{
    public partial class CIDRCalculator
    {
        ...
        public IPRange2CIDRModel IPRange2CIDRModel { get; set; } = null!;

        public CIDR2IPRangeModel CIDR2IPRangeModel { get; set; } = null!;

        public IEnumerable<CIDR> CIDRs { get; set; } = null!;
