...
public static class TradingServiceExtensions
{
    ...
    public static IServiceCollection AddTradingServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<BlazorWasmPortfolioGhAction.Services.Trading.VnDesk.TradeScoreService>();
        ...
        services.AddHttpClient<BlazorWasmPortfolioGhAction.Services.Trading.Broker.IBrokerAuthService,
            BlazorWasmPortfolioGhAction.Services.Trading.Broker.BrokerAuthService>(client =>
        {
            client.Timeout = TimeSpan.FromSeconds(30);
        });
        ...
        services.AddHttpClient<BlazorWasmPortfolioGhAction.Services.Trading.Tcbs.ITcbsApiClient,
            BlazorWasmPortfolioGhAction.Services.Trading.Tcbs.TcbsApiClient>(client =>
        {
