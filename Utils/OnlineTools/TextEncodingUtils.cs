...
internal static class TextEncodingUtils
{
    ...
    public static string ToNatoAlphabet(string text) => Convert(text, NatoAlphabet);
    public static string ToMorseCode(string text) => Convert(text, MorseCode);
    ...
    private static string Convert(string text, IReadOnlyDictionary<char, string> dictionary)
    {
        ...
        {
            var tokens = new List<string>(lines[i].Length);
